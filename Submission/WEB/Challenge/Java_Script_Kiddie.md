...
Quando abrimos o site temos um quadrado para digitarmos e um botão de envio. Colocando qualquer valor no campo e fazendo a submissão, recebemos uma string de volta:<br>
